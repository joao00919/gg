...
async def verify_emoji_async(app_id: str, bot_token: str, emoji_id: str) -> bool:
    ...
    fingerprint = hashlib.sha256(bot_token.encode("utf-8")).hexdigest()[:16]
    last_fingerprint = emojis_data.get("tokenFingerprint", "")

    should_verify = configured != "True" or (last_fingerprint and last_fingerprint != fingerprint)
