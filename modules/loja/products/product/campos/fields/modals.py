...
class CreateFieldModal(disnake.ui.Modal):
    def __init__(self, product_id: str, category_id: str | None = None):
        ...
        super().__init__(title="Criar Opção", components=components, custom_id=f"create_field_modal:{product_id}")
...
class EditFieldModal(disnake.ui.Modal):
    def __init__(self, product_id: str, field_id: str):
        ...
        super().__init__(title="Editar Opção", components=components, custom_id=f"edit_field_modal:{product_id}:{field_id}")
...
class EditInstructionsModal(disnake.ui.Modal):
    """Modal para editar apenas as instruções da opção"""
