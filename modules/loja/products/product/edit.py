    ...
    try:
        ...
        for msg_data in messages:
            try:
                ...
                if mode == "text":
                    await msg.edit(
                        content=send_product._build_text_content(product),
                        embed=None,
                        components=send_product._create_buy_button(product_id),
                    )
                elif mode == "legacy_basic":
                    await msg.edit(
                        content=None,
                        embed=send_product._build_basic_legacy_embed(product),
                        components=send_product._create_buy_button(product_id),
                    )
                elif mode == "legacy":
                    ...
                    await msg.edit(content=None, embed=embed, components=buy_button)
