...
class CartCleanup(commands.Cog):
    ...
    async def close_pending_carts(self):
        """
        Fecha e remove carrinhos pendentes após 10 minutos
        ...
        try:
            ...
            now = int(datetime.utcnow().timestamp())
            ten_minutes_ago = now - (10 * 60)  # 10 minutos em segundos
            ...
            for cart_id, cart in carts.items():
                ...
                # Verificar se passaram 10 minutos desde a criação
                    ...
                    if payment_provider == "sync_wallet":
                        try:
                            ...
                            if payment_id:
                                ...
                                print(f"✅ Pagamento Carteira Integrada {payment_id} cancelado por expiração: {result}")
                            else:
                            ...
                            print(f"❌ Erro ao cancelar pagamento Carteira Integrada expirado: {e}")
                                ...
                                if thread:
                                    ...
                                    if mode == "components":
                                            ...
                                            components=[
                                                disnake.ui.Container(
                                                    ...
                                                    disnake.ui.TextDisplay(
                                                        "**Carrinho Expirado**\n\n"
                                                        "Este carrinho foi fechado automaticamente após 10 minutos sem pagamento."
                                                    ),
                                        ...
                                        await thread.send(
                                            ...
                                            f"Este carrinho foi fechado automaticamente após 10 minutos sem pagamento."
                                        )
                                        ...
                                        await user.send(
                                            components=[
                                                disnake.ui.Container(
                                                    ...
                                                    disnake.ui.TextDisplay(
                                                        f"**Carrinho Expirado**\n\n"
                                                        f"Seu carrinho foi fechado automaticamente após 10 minutos sem pagamento.\n\n"
                                                        f"**Itens:**\n{items_block}"
                                                    ),
                                                    accent_colour=disnake.Colour.red()
                                                )
