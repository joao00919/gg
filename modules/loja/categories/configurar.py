...
class ConfigurarCategoria(commands.Cog):
    ...
    def _panel_components(inter: disnake.MessageInteraction, product_id: str, category_id: str) -> dict:
        ...
        for campo in campos.values():
            ...
            options.append(disnake.SelectOption(label=name, value=campo.get("id"), description="Opção da categoria"))
        if not options:
            disabled = True
        ...
        dropdown_campos_categoria = disnake.ui.StringSelect(
            placeholder=f"[{campos_na_categoria}] Selecione uma opção desta categoria",
            options=options,
...
-# Opções nesta categoria: `{campos_na_categoria}`
                """),
                disnake.ui.Separator(),
                disnake.ui.TextDisplay("**Opções nesta categoria**"),
                ...
                disnake.ui.ActionRow(
                    ...
                    disnake.ui.Button(label="Opções da Categoria", emoji=emoji.cardbox, custom_id=f"Loja_CamposCategoria:{product_id}:{category_id}"),
    ...
    def _panel_embed(inter: disnake.MessageInteraction, product_id: str, category_id: str) -> dict:
        ...
        embed_description = (
            ...
            f"-# Opções nesta categoria: `{campos_na_categoria}`"
        )
