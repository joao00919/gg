...
class EditPromptModal(disnake.ui.Modal):
    def __init__(self):
        ...
        super().__init__(title="Editar Configurações do ZYNEX Moderator", components=components)
...
# {emoji.z0}
-# Painel > Automações > **ZYNEX AI Moderator**
    ...
    def PainelCargoImune() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.z0}
-# Painel > Automações > ZYNEX AI Moderator > **Cargo Imune**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
    ...
    def PainelPrompt() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.z0}
-# Painel > Automações > ZYNEX AI Moderator > **Prompt**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
