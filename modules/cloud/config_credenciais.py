...
def CredentialsView_components() -> list[disnake.ui.Container]:
    ...
    explanation = (
        "Para utilizar os serviços da **SyncCloud**, é necessário um **bot exclusivo** que realiza a conexão com nossa **API**, permitindo que os **membros do seu servidor autorizem-o** de forma segura e integrada.\n\n"
    ...
    container = disnake.ui.Container(
        disnake.ui.TextDisplay(f"# {emoji.z0}\n-# Painel > SyncCloud > **Configurar Credenciais**"),
