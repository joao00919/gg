...
class Giveaways(commands.Cog):
    ...
    def GiveawaysEmbed(self, inter: disnake.MessageInteraction):
        ...
        embed = disnake.Embed(
            title=f"Sorteios & Gerenciamento",
    ...
    async def display_giveaways_panel(self, inter: disnake.MessageInteraction):
        ...
        if mode == "embed":
            ...
            panel = {"components": self.GiveawaysComponents(inter)}
    ...
    async def handle_giveaway_edit_actions(self, inter, action, giveaway_id):
        ...
        if action == "Rename":
            giveaway = (db.obter("database/giveaways/giveaways_data.json") or {}).get(giveaway_id, {})
            await inter.response.send_modal(
                RenameGiveawayModal(inter, giveaway_id, giveaway.get("name", "Novo Sorteio"))
            )
            return
