...
def PreferenciasView_components(inter: disnake.Interaction, panel_id: str) -> list:
    ...
    options = [
        disnake.SelectOption(label="Configurar Sistema de Transcripts", value="Transcripts", emoji=emoji.receipt, description="Definir regras do sistema de transcripts."),
        ...
        disnake.SelectOption(label="Configurar Fechamento de Tickets", value="CloseTickets", emoji=emoji.delete, description="Definir regras para fechamento e encerramento dos tickets."),
