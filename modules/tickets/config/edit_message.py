            ...
            disnake.ui.ActionRow(
                disnake.ui.StringSelect(
                    ...
                    options=[
                        ...
                        disnake.SelectOption(label="Editar Mensagem de Assumir Ticket", value="AssumeMessage", emoji=emoji.double_check, description="Editar a mensagem da função de assumir ticket."),
