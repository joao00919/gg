...
class BotInfo(commands.Cog):
    ...
    async def on_message(self, message: disnake.Message):
        ...
        contains_name = "zynex" in message.content.lower()
        ...
        if is_mention:
            ...
            buttons = disnake.ui.ActionRow(                disnake.ui.Button(label="Servidor de Suporte", url=(__import__("os").getenv("SUPPORT_URL") or "https://discord.com")),
            )
